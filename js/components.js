(function () {
  ...
  var HEADER_HTML = [
    ...
    '          <img src="{{ROOT}}images/logo/sunreef_ryukyu.png" alt="" class="nav-logo__mark" aria-hidden="true">',
  ...
  var FOOTER_HTML = [
    ...
    '            <img src="{{ROOT}}images/logo/sunreef_ryukyu.png" alt="" class="footer-brand__mark" aria-hidden="true">',
